...
class TestRegistryDiscovery:
    ...
    def test_create_env_manager_with_kwargs(self):
        ...
        assert (
            mgr.installation_kwargs["binary_dir_name"]
            == "CoppeliaSim_Pro_V4_1_0_Ubuntu20_04"
        )
...
class TestEnvVars:
    ...
    def test_env_vars_no_qt_platform(self):
        """QT_QPA_PLATFORM_PLUGIN_PATH is now handled by the render platform adapter."""
        from easi.simulators.registry import create_env_manager
...
class TestSimulatorClass:
    ...
    def test_name(self):
        from easi.simulators.coppeliasim.v4_1_0.simulator import (
            CoppeliaSimSimulatorV410,
        )
