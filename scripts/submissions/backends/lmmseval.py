...
_METRIC_MAP: dict[str, dict] = {
    "vsi_bench": {
        ...
        "overall_metric": "vsibench_score",
        "overall_is_dict": True,
        "scale": 1,
        "sub_scores": {
    ...
    "3dsrbench": {
        ...
        "scale": 100,
        "sub_scores": {
            "height_higher": "height_accuracy",
            "location_above": "location_accuracy",
            "orientation_in_front_of": "orientation_accuracy",
            "multi_object_closer_to": "multi_object_accuracy",
        },
    },
    "embspatial": {
